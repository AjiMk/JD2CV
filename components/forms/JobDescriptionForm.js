    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mt-2">
          Pro tip: Include the full job description including requirements, responsibilities, and preferred qualifications for best results.
        </p>
      </div>

      <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <h3 className="font-semibold text-blue-900 mb-2">Why provide a job description?</h3>
