...
export default function PersonalInfoForm({
  ...
  const inputClassName =
    "w-full rounded-xl border px-4 py-3 text-sm shadow-sm outline-none transition focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2";
  const errorClassName =
    "border-red-300 bg-red-50 text-red-900 placeholder:text-red-300 focus:border-red-500 focus:ring-red-200";
  const selectClassName =
    "w-full appearance-none rounded-xl border px-4 py-3 pr-10 text-sm shadow-sm outline-none transition focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 bg-background bg-[url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 fill=%22none%22 viewBox=%220 0 20 20%22 stroke=%22%236B7280%22%3E%3Cpath stroke-linecap=%22round%22 stroke-linejoin=%22round%22 stroke-width=%221.5%22 d=%22m6 8 4 4 4-4%22/%3E%3C/svg%3E')] bg-[length:1rem] bg-[position:right_0.85rem_center] bg-no-repeat";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <Input
            ...
            className={`${inputClassName} ${errors.fullName ? errorClassName : "border-input"}`}
        ...
        <div>
          ...
          <Input
            ...
            onChange={handleChange}
            readOnly
            className={`${inputClassName} bg-muted text-muted-foreground cursor-not-allowed ${errors.email ? errorClassName : "border-input"}`}
        ...
        <div>
          ...
          <Input
            ...
            onChange={handleChange}
            className={`${inputClassName} ${errors.phone ? errorClassName : "border-input"}`}
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className={`${selectClassName} ${errors.country ? errorClassName : "border-input"}`}
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className={`${selectClassName} ${errors.stateId ? errorClassName : "border-input"}`}
        ...
        <div>
          ...
          <Input
            ...
            onChange={handleChange}
            className={`${inputClassName} ${errors.pincode ? errorClassName : "border-input"}`}
            placeholder="110001"
        ...
        <div>
          ...
          <Input
            ...
            onChange={handleChange}
            className={`${inputClassName} ${errors.linkedin ? errorClassName : "border-input"}`}
        ...
        <div>
          ...
          <Input
            ...
            onChange={handleChange}
            className={`${inputClassName} ${errors.github ? errorClassName : "border-input"}`}
        ...
        <div className="md:col-span-2">
          ...
          <Input
            ...
            onChange={handleChange}
            className={`${inputClassName} ${errors.portfolio ? errorClassName : "border-input"}`}
        ...
        {showSummary ? (
          <div className="md:col-span-2">
            ...
            <Textarea
              ...
              onChange={handleChange}
              rows="4"
              className={`${inputClassName} ${errors.summary ? errorClassName : "border-input"}`}
