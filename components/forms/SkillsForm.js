  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <h3 className="font-semibold text-gray-900 mb-3">Suggested Technical Skills</h3>
        <div className="flex flex-wrap gap-2">
          {[
            'JavaScript', 'Python', 'Java', 'React', 'Node.js', 'TypeScript',
            'AWS', 'Docker', 'Git', 'SQL', 'MongoDB', 'REST APIs', 'GraphQL',
            'Next.js', 'TailwindCSS', 'CI/CD', 'Agile', 'Kubernetes'
          ].map((skill) => (
            <button
              key={skill}
              onClick={() => {
        ...
        <h3 className="font-semibold text-gray-900 mb-3 mt-4">Suggested Soft Skills</h3>
        <div className="flex flex-wrap gap-2">
          {[
